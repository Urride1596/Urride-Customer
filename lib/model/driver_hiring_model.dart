class DriverHiringModel {
  String? success;
  String? error;
  String? message;
  List<DriverHiringData>? data;

  DriverHiringModel({this.success, this.error, this.message, this.data});

  DriverHiringModel.fromJson(Map<String, dynamic> json) {
    success = json['success'];
    error = json['error'];
    message = json['message'];
    if (json['data'] != null) {
      data = <DriverHiringData>[];
      json['data'].forEach((v) {
        data!.add(DriverHiringData.fromJson(v));
      });
    }
  }
...
class DriverHiringData {
  ...
  DriverHiringData.fromJson(Map<String, dynamic> json) {
    id = json['id'].toString();
  ...
  static void add(DriverHiringData driverHiringData) {}
}
