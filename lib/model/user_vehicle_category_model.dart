class UserVehicleCategoryModel {
  String? success;
  String? error;
  String? message;
  List<UserVehicleData>? data;

  UserVehicleCategoryModel({this.success, this.error, this.message, this.data});

  UserVehicleCategoryModel.fromJson(Map<String, dynamic> json) {
    ...
    if (json['data'] != null) {
      ...
      json['data'].forEach((v) {
        data!.add(UserVehicleData.fromJson(v));
      });
    }
  }
...
class UserVehicleData {
  ...
  UserVehicleData.fromJson(Map<String, dynamic> json) {
    id = json['id'].toString();
