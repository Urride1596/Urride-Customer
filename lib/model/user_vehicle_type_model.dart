class UserVehicleTypeModel {
  String? success;
  String? error;
  String? message;
  List<UserVechileData>? data;

  UserVehicleTypeModel({this.success, this.error, this.message, this.data});

  UserVehicleTypeModel.fromJson(Map<String, dynamic> json) {
    success = json['success'];
    error = json['error'];
    message = json['message'];
    if (json['data'] != null) {
      data = <UserVechileData>[];
      json['data'].forEach((v) {
        data!.add(UserVechileData.fromJson(v));
      });
    }
  }
...
class UserVechileData {
  ...
  UserVechileData.fromJson(Map<String, dynamic> json) {
    id = json['id'].toString();
